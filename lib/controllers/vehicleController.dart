...
import 'package:spark/services/vehicle_service.dart';
...
class VehicleController extends GetxController {
  ...
  XFile? pickedFile1;
  //var _isFile1picked = false.obs;
  //bool _isFile2picked = false;
  XFile? pickedFile2;
      ...
      if (formKey.currentState!.validate()) {
        if (pickedFile1 != null) {
          Dio.FormData formData = new Dio.FormData.fromMap({
            "name": name.text,
            "year": year.text,
            "selfie": await Dio.MultipartFile.fromFile(pickedFile1!.path,
                filename: pickedFile1!.path.split('/').last),
            "id_card": await Dio.MultipartFile.fromFile(pickedFile2!.path,
